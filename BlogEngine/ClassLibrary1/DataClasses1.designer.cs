...
namespace ClassLibrary1
{
    ...
    partial void Insertbe_FileStoreDirectory(be_FileStoreDirectory instance);
    partial void Updatebe_FileStoreDirectory(be_FileStoreDirectory instance);
    partial void Deletebe_FileStoreDirectory(be_FileStoreDirectory instance);
    partial void Insertbe_FileStoreFileThumb(be_FileStoreFileThumb instance);
    partial void Updatebe_FileStoreFileThumb(be_FileStoreFileThumb instance);
    partial void Deletebe_FileStoreFileThumb(be_FileStoreFileThumb instance);
    partial void Insertbe_FileStoreFile(be_FileStoreFile instance);
    partial void Updatebe_FileStoreFile(be_FileStoreFile instance);
    partial void Deletebe_FileStoreFile(be_FileStoreFile instance);
    #endregion
		
		public DataClasses1DataContext() : 
				base(global::ClassLibrary1.Properties.Settings.Default.BlogEngineFileStoreConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<be_FileStoreDirectory> be_FileStoreDirectories
		{
			get
			{
				return this.GetTable<be_FileStoreDirectory>();
			}
		}
		
		public System.Data.Linq.Table<be_FileStoreFileThumb> be_FileStoreFileThumbs
		{
			get
			{
				return this.GetTable<be_FileStoreFileThumb>();
			}
		}
		
		public System.Data.Linq.Table<be_FileStoreFile> be_FileStoreFiles
		{
			get
			{
				return this.GetTable<be_FileStoreFile>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.be_FileStoreDirectory")]
	public partial class be_FileStoreDirectory : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<be_FileStoreFile> _be_FileStoreFiles;
    ...
    partial void OnLastModifyChanged();
		...
		{
			this._be_FileStoreFiles = new EntitySet<be_FileStoreFile>(new Action<be_FileStoreFile>(this.attach_be_FileStoreFiles), new Action<be_FileStoreFile>(this.detach_be_FileStoreFiles));
			OnCreated();
		}
		...
		public EntitySet<be_FileStoreFile> be_FileStoreFiles
		{
			get
			{
		...
		private void attach_be_FileStoreFiles(be_FileStoreFile entity)
		{
			this.SendPropertyChanging();
			entity.be_FileStoreDirectory = this;
		}
		
		private void detach_be_FileStoreFiles(be_FileStoreFile entity)
		{
			this.SendPropertyChanging();
			entity.be_FileStoreDirectory = null;
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.be_FileStoreFileThumbs")]
	public partial class be_FileStoreFileThumb : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<be_FileStoreFile> _be_FileStoreFile;
    ...
    partial void OncontentsChanged();
		...
		public be_FileStoreFileThumb()
		{
			this._be_FileStoreFile = default(EntityRef<be_FileStoreFile>);
			OnCreated();
		}
		...
		public be_FileStoreFile be_FileStoreFile
		{
			get
			{
			...
			set
			{
				be_FileStoreFile previousValue = this._be_FileStoreFile.Entity;
							...
							|| (this._be_FileStoreFile.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.be_FileStoreFileThumbs.Remove(this);
					}
					this._be_FileStoreFile.Entity = value;
					if ((value != null))
					{
						value.be_FileStoreFileThumbs.Add(this);
	...
	public partial class be_FileStoreFile : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<be_FileStoreFileThumb> _be_FileStoreFileThumbs;
		
		private EntityRef<be_FileStoreDirectory> _be_FileStoreDirectory;
    ...
    partial void OnLastModifyChanged();
		...
		public be_FileStoreFile()
		{
			this._be_FileStoreFileThumbs = new EntitySet<be_FileStoreFileThumb>(new Action<be_FileStoreFileThumb>(this.attach_be_FileStoreFileThumbs), new Action<be_FileStoreFileThumb>(this.detach_be_FileStoreFileThumbs));
			this._be_FileStoreDirectory = default(EntityRef<be_FileStoreDirectory>);
			OnCreated();
		}
		...
		public EntitySet<be_FileStoreFileThumb> be_FileStoreFileThumbs
		{
			get
			{
		...
		public be_FileStoreDirectory be_FileStoreDirectory
		{
			get
			{
			...
			set
			{
				be_FileStoreDirectory previousValue = this._be_FileStoreDirectory.Entity;
				if (((previousValue != value) 
							|| (this._be_FileStoreDirectory.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.be_FileStoreFiles.Remove(this);
					}
					this._be_FileStoreDirectory.Entity = value;
					if ((value != null))
					{
						value.be_FileStoreFiles.Add(this);
		...
		private void attach_be_FileStoreFileThumbs(be_FileStoreFileThumb entity)
		{
			this.SendPropertyChanging();
			entity.be_FileStoreFile = this;
		}
		
		private void detach_be_FileStoreFileThumbs(be_FileStoreFileThumb entity)
		{
			this.SendPropertyChanging();
			entity.be_FileStoreFile = null;
		}
	}
}
