...
<div class="post">
    ...
    <div class="descr"><img id="Img1" src="~/themes/indigo/img/timeicon.gif" runat="server" alt="" /> <%=Post.DateCreated.ToString("MMMM d, yyyy HH:mm")%> by <img id="Img2" src="~/themes/indigo/img/author.gif" runat="server" alt="" /> <a href="<%=VirtualPathUtility.ToAbsolute("~/") + "author/" + Post.Author %>.aspx"><%=Post.Author %></a></div>
    ...
    <div class="postfooter">
        ...
        <a href="<%=Post.RelativeLink %>#comment"><img id="Img3" src="~/themes/indigo/img/comments.gif" runat="server" alt="" /> Comments (<%=Post.Comments.Count %>)</a> |
