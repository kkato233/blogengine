...
<script language="javascript" type="text/javascript">
  tinyMCE.init({
    ...
    elements : "<%=txtContent.ClientID %>",
	  ...
	  plugins : "fullscreen,contextmenu,cleanup,emotions,media,table",
	  theme_advanced_buttons1_add_before : "fullscreen,code,separator,cut,copy,paste,separator,undo,redo,separator",
	  theme_advanced_buttons1_add : "separator,bullist,numlist,outdent,indent,separator,link,unlink,media,sub,sup,removeformat,cleanup,charmap,emotions,separator,formatselect,fontselect,fontsizeselect",
