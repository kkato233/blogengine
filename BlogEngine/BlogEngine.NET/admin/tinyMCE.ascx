...
<script language="javascript" type="text/javascript">
  tinyMCE.init({
    ...
    elements : "<%=txtContent.ClientID %>",
	  ...
	  extended_valid_elements : "a[id|style|rel|rev|charset|hreflang|dir|lang|tabindex|accesskey|type|name|href|target|title|class|onfocus|onblur|onclick|ondblclick|onmousedown|onmouseup|onmouseover|onmousemove|onmouseout|onkeypress|onkeydown|onkeyup|search|category|asin],hr[class|width|size|noshade],font[face|size|color|style],span[class|align|style],script[charset|defer|language|src|id|type],code,iframe[src|width|height|frameborder|name|style]",
