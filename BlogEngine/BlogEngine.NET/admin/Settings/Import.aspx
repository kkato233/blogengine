		...
		<div class="content-box-left">
            ...
            <ul class="fl leftaligned">
                <li>
                    ...
                    <asp:Button ID="btnBlogMLImport" runat="server" CssClass="btn rounded" Text="Import from file" OnClick="BtnBlogMlImportClick" OnClientClick="$('#ImportLoader').addClass('loader')" />
