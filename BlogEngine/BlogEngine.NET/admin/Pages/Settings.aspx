...
<asp:Content ID="Content1" ContentPlaceHolderID="cphAdmin" runat="Server">
    ...
    <div class="settings">
        <h1>
            ...
            <%=Resources.labels.settings.ToLowerInvariant() %></h1>
        ...
        <div>
            <label for="<%=txtPostsPerPage.ClientID %>">
                <%=Resources.labels.postPerPage %></label>
            ...
            <asp:CompareValidator runat="server" ControlToValidate="txtPostsPerPage" Operator="DataTypeCheck"
                Type="integer" ErrorMessage="<%$Resources:labels,enterValidNumber %>" />
        </div>
        <div style="margin-bottom: 0">
            <label for="<%=ddlTheme.ClientID %>">
                <%=Resources.labels.theme %></label>
            <asp:DropDownList runat="server" ID="ddlTheme" />
            <a href="javascript:void(PreviewTheme());">
                <%=Resources.labels.preview %></a> | <a href="http://www.dotnetblogengine.net/page/themes.aspx"
                    target="_blank">
                    <%=Resources.labels.download %></a>
        </div>
        <div style="margin-bottom: 3px">
            <label for="<%=ddlMobileTheme.ClientID %>">
                <%=Resources.labels.mobileTheme %></label>
            <asp:DropDownList runat="server" ID="ddlMobileTheme" />
        </div>
        <div style="margin-bottom: 3px">
            <label for="<%=txtThemeCookieName.ClientID %>">
                <%=Resources.labels.themeCookieName %></label>
            <asp:TextBox runat="server" ID="txtThemeCookieName" />
        </div>
        <div style="margin-bottom: 3px">
            <label for="<%=cbUseBlogNameInPageTitles.ClientID %>">
                <%=Resources.labels.useBlogNameInPageTitles%></label>
        ...
        <div style="margin-bottom: 3px">
            <label for="<%=cbShowRelatedPosts.ClientID %>">
                <%=Resources.labels.showRelatedPosts %></label>
            <asp:CheckBox runat="server" ID="cbShowRelatedPosts" />
        </div>
        <div style="margin-bottom: 3px">
            <label for="<%=cbEnableRating.ClientID %>">
                <%=Resources.labels.enableRating %></label>
            <asp:CheckBox runat="server" ID="cbEnableRating" />
        </div>
        <div style="margin-bottom: 3px">
            <label for="<%=cbShowDescriptionInPostList.ClientID %>">
                <%=Resources.labels.showDescriptionInPostList %></label>
            <asp:CheckBox runat="server" ID="cbShowDescriptionInPostList" />
            <label for="<%=txtDescriptionCharacters.ClientID %>" style="float: none; position: relative;
                top: -2px;">
                <%=Resources.labels.numberOfCharacters %></label>
            <asp:TextBox runat="server" ID="txtDescriptionCharacters" Width="40" />
            <asp:CompareValidator runat="server" ControlToValidate="txtDescriptionCharacters"
                Type="Integer" Operator="DataTypeCheck" ID="valDescChar" SetFocusOnError="true" />
        </div>
        <div style="margin-bottom: 0">
            <label for="<%=cbShowDescriptionInPostListForPostsByTagOrCategory.ClientID %>">
                <%=Resources.labels.showDescriptionInPostListForPostsByTagOrCategory %></label>
            <asp:CheckBox runat="server" ID="cbShowDescriptionInPostListForPostsByTagOrCategory" />
            <label for="<%=txtDescriptionCharactersForPostsByTagOrCategory.ClientID %>" style="float: none;
                position: relative; top: -2px;">
                <%=Resources.labels.numberOfCharacters %></label>
            <asp:TextBox runat="server" ID="txtDescriptionCharactersForPostsByTagOrCategory"
                Width="40" />
            <asp:CompareValidator runat="server" ControlToValidate="txtDescriptionCharactersForPostsByTagOrCategory"
                Type="Integer" Operator="DataTypeCheck" SetFocusOnError="true" />
        </div>
        <br />
        <div style="margin-bottom: 3px">
            <label for="<%=cbTimeStampPostLinks.ClientID %>">
                <%=Resources.labels.timeStampPostLinks %></label>
            <asp:CheckBox runat="server" ID="cbTimeStampPostLinks" />
        </div>
        <div style="margin-bottom: 3px">
            <label for="<%=cbShowPostNavigation.ClientID %>">
                <%=Resources.labels.showPostNavigation %></label>
            <asp:CheckBox runat="server" ID="cbShowPostNavigation" />
        </div>
        <div style="margin-bottom: 0">
            <label for="<%=ddlCulture.ClientID %>">
                <%=Resources.labels.language %></label>
        ...
        <div style="margin-bottom: 3px">
            <label for="<%=txtTimeZone.ClientID %>">
                <%=Resources.labels.timezone %></label>
            <asp:TextBox runat="Server" ID="txtTimeZone" Width="30" />
            Server time:
            <%=DateTime.Now.ToShortTimeString() %>
            <asp:CompareValidator runat="server" ControlToValidate="txtTimeZone" Operator="dataTypeCheck"
                Type="double" Display="dynamic" ErrorMessage="<%$Resources:labels,enterValidNumberPositiveNegative %>" />
        </div>
        <div style="margin-bottom: 3px">
            <label for="<%=cbEnableSelfRegistration.ClientID %>">
                <%=Resources.labels.enableSelfRegistration %></label>
            <asp:CheckBox runat="server" ID="cbEnableSelfRegistration" />
        </div>
        <div style="margin-bottom: 3px">
            <label for="<%=cbRequireLoginToViewPosts.ClientID %>">
                <%=Resources.labels.onlyLoggedInCanView %></label>
            <asp:CheckBox runat="server" ID="cbRequireLoginToViewPosts" />
        </div>
    </div>
    <div class="settings">
        <h1>
            <%=Resources.labels.advancedSettings %></h1>
        <div style='display: <%= (Utils.IsMono) ? "none" : "block" %>'>
            <label for="<%=cbEnableCompression.ClientID %>">
                <%=Resources.labels.enableHttpCompression %></label>
        ...
        <label for="<%=cbRemoveWhitespaceInStyleSheets.ClientID %>">
            <%=Resources.labels.trimStylesheet %></label>
        <asp:CheckBox runat="server" ID="cbRemoveWhitespaceInStyleSheets" /><%=Resources.labels.trimStylesheetDescription %><br />
        <label for="<%=cbCompressWebResource.ClientID %>">
            <%=Resources.labels.compressWebResource %></label>
        ...
        <label for="">
            <%=Resources.labels.enablePingbacks %></label>
        ...
        <label for="<%=rblWwwSubdomain.ClientID %>">
            <%=Resources.labels.handleWwwSubdomain %></label>
        ...
        <br />
        <label for="<%=cbEnableErrorLogging.ClientID %>">
            <%=Resources.labels.enableErrorLogging %></label>
    ...
    <div class="settings">
        ...
        <div style="margin-bottom: 3px">
            <label for="<%=txtSmtpServerPort.ClientID %>">
                <%=Resources.labels.portNumber %></label>
            ...
            <asp:CompareValidator ID="CompareValidator2" runat="Server" ControlToValidate="txtSmtpServerPort"
                Operator="datatypecheck" Type="integer" ErrorMessage="<%$ Resources:labels, noValidNumber %>" /><br />
        </div>
        <div style="margin-bottom: 3px">
            <label for="<%=txtSmtpUsername.ClientID %>">
                <%=Resources.labels.userName %></label>
        ...
        <label for="<%=cbEnableSsl.ClientID %>">
            <%=Resources.labels.enableSsl%></label>
        <asp:CheckBox runat="Server" ID="cbEnableSsl" /><br />
        <label for="<%=cbComments.ClientID %>">
            <%=Resources.labels.sendCommentEmail %></label>
        <asp:CheckBox runat="Server" ID="cbComments" /><br />
        <label for="<%=txtEmailSubjectPrefix.ClientID %>">
            <%=Resources.labels.emailSubjectPrefix %></label>
        <asp:TextBox runat="server" ID="txtEmailSubjectPrefix" Width="300" /><br />
        <br />
    ...
    <div class="settings">
        ...
        <div>
            <label for="<%=ddlSyndicationFormat.ClientID %>" style="position: relative; top: 4px">
                <%=Resources.labels.defaultFeedOutput %></label>
        ...
        <div style="margin-bottom: 3px">
            <label for="<%=txtPostsPerFeed.ClientID %>">
                <%=Resources.labels.postsPerFeed %></label>
        ...
        <div style="margin-bottom: 3px">
            <label for="<%=cbEnableEnclosures.ClientID %>">
                <%=Resources.labels.enableEnclosures %></label>
            <asp:CheckBox runat="server" ID="cbEnableEnclosures" />
        </div>
        <div style="margin-bottom: 3px">
            <label for="<%=txtBlogChannelBLink.ClientID %>">
                <%=Resources.labels.endorsment %></label>
            <asp:TextBox runat="server" ID="txtBlogChannelBLink" MaxLength="255" Width="300" />
        </div>
        <div style="margin-bottom: 3px">
            <label for="<%=txtAlternateFeedUrl.ClientID %>">
                <%=Resources.labels.alternateFeedUrl %></label>
            <asp:TextBox runat="server" ID="txtAlternateFeedUrl" Width="300" />
            <em>(http://feeds.feedburner.com/username)</em>
            <asp:RegularExpressionValidator runat="Server" ControlToValidate="txtAlternateFeedUrl"
                ValidationExpression="(http://|https://|)([\w-]+\.)+[\w-]+(/[\w- ./?%&=;~]*)?"
                ErrorMessage="<%$Resources:labels,enterValidUrl %>" Display="Dynamic" />
        </div>
    </div>
    <div class="settings">
        <h1>
    ...
    <div class="settings">
        <h1>
            <%=Resources.labels.trackingScript %></h1>
    ...
    <div class="settings">
        <h1>
            <%=Resources.labels.import %>
            &
            <%=Resources.labels.export %></h1>
        <p>
            <%=Resources.labels.blogMLDescription %>
            (<a href="http://blogml.org/" target="_blank">blogml.org</a>) </p>
