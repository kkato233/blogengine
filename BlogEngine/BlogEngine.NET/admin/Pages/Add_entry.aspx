...
<asp:Content ID="Content1" ContentPlaceHolderID="cphAdmin" runat="Server">
    <div id="tagselector" style="display: none">
        <a href="javascript:void(ToggleTagSelector())" style="color: Black; float: right">
            <%=Resources.labels.close %></a>
    ...
    <asp:Label AssociatedControlID="txtTitle" runat="server" Text='<%$ Code: Resources.labels.title %>' />
    <asp:TextBox runat="server" ID="txtTitle" Width="450px" />&nbsp;&nbsp;&nbsp;
    <asp:Label AssociatedControlID="ddlAuthor" runat="server" Text='<%$ Code: Resources.labels.author %>' />
    <asp:DropDownList runat="Server" ID="ddlAuthor" />
    &nbsp;&nbsp;&nbsp;
    <asp:Label AssociatedControlID="txtDate" runat="server" Text='<%$ Code: Resources.labels.date %>' />
    ...
    <asp:CheckBox runat="server" ID="cbUseRaw" Text="<%$Resources:labels,useRawHtmlEditor %>"
        AutoPostBack="true" />
    <asp:RegularExpressionValidator runat="server" ControlToValidate="txtDate" ValidationExpression="[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9] [0-9][0-9]:[0-9][0-9]"
        ErrorMessage="<%$Resources:labels,enterValidDate %>" Display="dynamic" />
    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtDate" ErrorMessage="<%$Resources:labels,enterDate %>"
        Display="Dynamic" />
    ...
    <table id="entrySettings">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtCategory" ErrorMessage="<%$ Resources:labels, required %>"
                    ValidationGroup="category" /><br />
