    ...
    <asp:CreateUserWizard ID="RegisterUser" runat="server" EnableViewState="false" 
        ...
        <WizardSteps>
            <asp:CreateUserWizardStep ID="RegisterUserWizardStep" runat="server">
                <ContentTemplate>
                    <p>
                        <span id="CreateHdr"><%=Resources.labels.createAccount %></span>
                        <span>
                            <%=Resources.labels.alreadyHaveAccount %> <a href="~/Account/Login.aspx" ID="HeadLoginStatus" runat="server"><%=Resources.labels.loginNow %></a>
                        </span>
                    </p>
                    <div class="accountInfo">
                        ...
                        <p class="submitButton">
                            <asp:Button ID="CreateUserButton" runat="server" CommandName="MoveNext" Text="<%$Resources:labels,createUser %>" OnClientClick="return ValidateNewUser()" />
                        </p>
                    </div>
                </ContentTemplate>
