...
/// </summary>
public partial class blogroll : System.Web.UI.UserControl
{
  ...
  private void BlogSettings_Changed(object sender, EventArgs e)
  {
    _Items = null;
  }
  ...
  /// <summary>
  /// Gets or sets the minutes between RSS updates.
  /// </summary>
  public int MinutesCached
  {
    get { return (int)(ViewState["MinutesCached"] ?? 60); }
    set { ViewState["MinutesCached"] = value; }
  }
  ...
  /// </summary>
  private void DisplayBlogroll()
  {
    if (DateTime.Now > _LastUpdated.AddMinutes(MinutesCached) && BlogSettings.Instance.BlogrollVisiblePosts > 0)
    {
      _Items = null;
