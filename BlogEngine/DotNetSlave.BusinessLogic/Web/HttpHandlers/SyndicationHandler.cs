...
namespace BlogEngine.Core.Web.HttpHandlers
{
    ...
    public class SyndicationHandler : IHttpHandler
    {
        ...
        //	PRIVATE ROUTINES
        //============================================================
        #region SetHeaderInformation(HttpContext context, List<Post> posts)
        /// <summary>
            ...
            try
            {
                ...
                switch(this.Format)
                {
                    case SyndicationFormat.Atom:
                        ...
                        //------------------------------------------------------------
                        using (AtomEngineSyndicationFeedAdapter atomAdapter = new AtomEngineSyndicationFeedAdapter(posts, BlogSettings.Instance, CategoryDictionary.Instance))
                        {
                            //------------------------------------------------------------
                    ...
                    case SyndicationFormat.Rss:
                        ...
                        //	Create adapter to fill feed
                        //------------------------------------------------------------
                        using (RssEngineSyndicationFeedAdapter rssAdapter = new RssEngineSyndicationFeedAdapter(posts, BlogSettings.Instance, CategoryDictionary.Instance))
                        {
                            //------------------------------------------------------------
                            //	Set adapter properties
                            //------------------------------------------------------------
